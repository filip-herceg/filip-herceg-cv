...
|-------|------|----------------------|--------------------|
| 1 | Extract duplicated literals & magic numbers into constants modules | pdf route, cv service, tests | 40ΓÇô60 |
| 2 | Consolidate test helpers / mocks | `src/tests/**` | 30ΓÇô50 |
| 3 | Reduce cognitive complexity via helper extraction | `app/cv/page.tsx`, `CvView.tsx` | 25ΓÇô35 |
| 4 | Update deprecated APIs (Sentry/Next) | `sentry.*.config.ts` | 5ΓÇô8 |
| 5 | Resolve empty / placeholder / TODO patterns | misc test setup & TODOs | 10ΓÇô15 |
| 6 | A11y & semantics cleanup | CV UI, navigation | 15ΓÇô25 |
| 7 | Remove param reassignment & add purity | auth/rate limiter | 8ΓÇô12 |
| 8 | Logging/tracing helpers unify patterns | logger, tracing, pdf route | 5ΓÇô10 |
| 9 | Residual types & polish | varied | 6ΓÇô10 |
| 10 | Verification & gating | CI config | ΓÇö |
